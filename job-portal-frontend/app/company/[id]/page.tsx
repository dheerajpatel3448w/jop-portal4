...
const CompanyPage = () => {
  ...
  async function fetchCompany() {
    try {
      setLoading(true);
      const { data } = await axios.get(`${job_service}/job/getcompanydetails/${id}`,{
  ...
  const addJobHandler = async () => {
    ...
    try {
      ...
      await axios.post(`${job_service}/job/createjob`, jobData, {
        headers: {
  ...
  const deleteHandler = async (jobId: number) => {
    if (confirm("Are you sure you want to delete this job?")) {
      setBtnLoading(true);
      try {
        await axios.delete(`${job_service}/job/deletecompany/${jobId}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
          withCredentials:true
  ...
  const updateJobHandler = async () => {
    ...
    try {
      ...
      await axios.put(
        `${job_service}/job/updatejob/${selectedJob.job_id}`,
        updateData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
