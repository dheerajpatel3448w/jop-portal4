"use client"
import { ArrowRight, BookOpen, Briefcase, Lightbulb, Loader2, Target, TrendingUp, X } from 'lucide-react'
...
const Careerguide = () => {
    ...
    const getCarrerGuidance = async () => {
        ...
        setLoading(true);
        try {
            const {data}=await axios.post(`${utils_service}/ai/career`,{skill:skills});
            setResponse(data.data);
            console.log(data);
            alert("Carrer guidance generated successfully!");
        } catch (error) {
            alert("Failed to generate carrer guidance. Please try again.");
        }
        finally{
            setLoading(false);
        }
                ...
                <div className="space-y-6 py-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {response.skillToLearn?.map((category, index) => (
