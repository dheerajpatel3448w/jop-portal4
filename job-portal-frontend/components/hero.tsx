import { ArrowRight, Briefcase, DivideCircle, Search, SearchCheck, TrendingDown, TrendingUp } from 'lucide-react'
            ...
            <div className='flex flex-col-reverse md:flex-row items-center gap-12 md:gap-16'>
                <div className='flex-1 flex flex-col items-center md:items-start text-center md:text-left space-y-6'>
                    ...
                    <h1 className=' text-4xl md:text-5xl lg:text-6xl font-bold leading-tight '>
                        Find Your Dream Job at {" "} <span className=' inline-block '>Hire <span className='text-red-500'>Heaven</span></span>
                    </h1>
                     {/* description */}
                     <p className='text-lg md:text-xl leading-relaxed opacity-80 max-w-2xl '>
                        connect with top employers and explore thousands of job opportunities tailored to your skills and aspirations.
                     </p>
                     {/*stats*/}
                     <div className='flex flex-wrap justify-center md:justify-start gap-8 py-4 '>
                        <div className='text-center md:text-left'>
                            ...
                            <p className='text-sm opacity-78'>
                                Active Jobs
                            </p>
                     ...
                     <div className='flex flex-col sm:flex-row gap-4 pt-2 '>
                        ...
                        <Button variant={"outline"} size={"lg"} className='text-base px-8 h-12 gap-2 group transition-all' >
                            ...
                            <Briefcase className='group-hover:translate-x-1 transition-transform'/>
                            Learn more
                        </Button>
                        </Link>
                ...
                <div className=' flex-1  relative'>
                    <div className=' relative group'>
                        ...
                        <div className=' relative rounded-2xl overflow-hidden shadow-2xl border-4 border-background '>
                            <img src='gemini.png' alt='hero-image' className='w-full h-full object-cover  object-center transform transition-transform duration-500 group-hover:scale-105 '/>
                        </div>
                    </div>
                </div> 
